...
inline void log_t::write_checkpoint(lsn_t end_lsn) noexcept
{
  ...
  mach_write_to_8(my_assume_aligned<8>(checkpoint_buf + 16),
                  log.calc_lsn_offset(next_checkpoint_lsn));
  ut_ad(!memcmp_aligned<4>(checkpoint_buf + 24, field_ref_zero, 60 - 24));
